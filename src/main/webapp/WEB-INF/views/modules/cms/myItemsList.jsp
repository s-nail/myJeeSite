...
<body>
    ...
    <div id="importBox" class="hide">
		<form id="importForm" action="${ctx}/cms/import" method="post" enctype="multipart/form-data"
			class="form-search" style="padding-left:20px;text-align:center;" onsubmit="loading('正在导入，请稍等...');"><br/>
			<input id="uploadFile" name="file" type="file" style="width:330px"/><br/><br/>　　
			<input id="btnImportSubmit" class="btn btn-primary" type="submit" value="   导    入   "/>
			<a href="${ctx}/cms/import/template">下载模板</a>
		</form>
	</div>

	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/cms/myItemsList/">商品列表</a></li>
		<shiro:hasPermission name="cms:items:edit">
			<li><a href="${ctx}/cms/myItemForm">商品添加</a></li>
		</shiro:hasPermission>
	</ul>
	
	<form:form id="searchForm" modelAttribute="itemsEntity" action="${ctx}/sys/user/list" method="post" class="breadcrumb form-search ">
		...
		<ul class="ul-form">
			...
			<li><label>商品名称：</label><form:input path="itemName" htmlEscape="false" maxlength="50" class="input-medium"/></li>
